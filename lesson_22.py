...
import os
d = os.getcwd()
print(f'Current working directory: {d}') #Current directory

#Change folders
os.chdir('..')
print(f'Current working directory: {os.getcwd()}') #Current directory
os.chdir(d)
print(f'Current working directory: {os.getcwd()}') #Current directory
...
#ScanDir - Python 3.5
#https://docs.python.org/3/libary/os.html#os.scandir
for e in os.scandir():
    print(e)
    print(f'Name: {e.name}')
    print(f'Path: {e.path}')
