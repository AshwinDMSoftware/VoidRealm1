...
print(str.upper()) #Make UpperCase
print(str.lower()) #Make LowerCase
print(str.capitalize()) #Make Capitalized

#Slicing - or getting a sub string
print(str[0:5]) #Get first 5 - zero based
print(str[6:]) #Get the 6th to the end
print(str[-7:]) #Get from the last 7
print(str[6:11]) #Get from 6 to 11

#Indexs - the position of
l = ","
c = str.find(l) #-1 if not found (Does not return an error)
